...
public class RecyclerViewOngoingTrainingAdapter extends RecyclerView.Adapter<RecyclerViewOngoingTrainingAdapter.MyViewHolder> {
    private Context context;
    private List<TrainingModel> trainingModels = new ArrayList<>();

    public RecyclerViewOngoingTrainingAdapter(Context context, List<TrainingModel> userModel){
    ...
    @NonNull
    @Override
    public RecyclerViewOngoingTrainingAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new RecyclerViewOngoingTrainingAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerViewOngoingTrainingAdapter.MyViewHolder holder, int position) {
